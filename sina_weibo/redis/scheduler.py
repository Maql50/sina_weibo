...
QUEUE_KEY = 'requests:%(spider)s'
QUEUE_CLASS = 'sina_weibo.redis.queue.SpiderPriorityQueue'
...
class Scheduler(object):
    ...
    def open(self, spider):
        ...
        if spider.cell_id:
            self.df = RFPDupeFilter(self.server, self.dupefilter_key % {'spider': spider.cell_id})
        else:
